...
T = TypeVar('T', bound='ImageBaseConfiguration')
class ImageBaseConfiguration(ConfigMixin):
    config_name = "ImageBaseConfiguration"
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        for key, value in vars(self).items():
            if isinstance(value, ImageBaseConfiguration):
                d[key] = value.to_dict()  # Serialize nested ImageBaseConfiguration instances
